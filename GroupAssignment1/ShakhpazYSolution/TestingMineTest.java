...
public class TestingMineTest {
    ...
    void testCheckEmpty() {
        ...
        ShakhpazYSolution.checkEmpty(field);
    ...
    void testCheckSurroundingsEdge() {
        ...
        ShakhpazYSolution.checkSurroundings(currentRow, currentCol, field);
    ...
    void testCheckSurroundingIntersection() {
        ...
        ShakhpazYSolution.checkSurroundings(firstRow, firstCol, field);
        ShakhpazYSolution.checkSurroundings(secondRow, secondCol, field);
